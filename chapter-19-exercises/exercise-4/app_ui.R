...
intro_panel <- tabPanel(
  ...
  p(href = "a(https://www.nytimes.com/interactive/2017/08/07/opinion/leonhardt-income-inequality.html)",
    "(source)"),
  ...
  # text.
  p("The diagram shows that lower income individuals used to see greater income growth but now they
    see", strong("less"), "income growth. Now, the top", em("99.999th"), "percentile see the
